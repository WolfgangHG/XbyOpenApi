...
namespace XbyOpenApi.Core.Client.Two.Chat.Conversations.Item.Typing
{
  /// <summary>
  ...
  {
    /// <summary>
    /// Instantiates a new <see cref="global::XbyOpenApi.Core.Client.Two.Chat.Conversations.Item.Typing.TypingRequestBuilder"/> and sets the default values.
    /// </summary>
...
#nullable restore
    ...
    /// </summary>
    /// <returns>A <see cref="global::XbyOpenApi.Core.Client.Two.Chat.Conversations.Item.Typing.TypingRequestBuilder"/></returns>
    /// <param name="rawUrl">The raw URL to use for the request builder.</param>
    public global::XbyOpenApi.Core.Client.Two.Chat.Conversations.Item.Typing.TypingRequestBuilder WithUrl(string rawUrl)
    {
      return new global::XbyOpenApi.Core.Client.Two.Chat.Conversations.Item.Typing.TypingRequestBuilder(rawUrl, RequestAdapter);
    }
  }
}
