...
using XbyOpenApi.Core.Client.Two.Chat.Conversations.Group;
using XbyOpenApi.Core.Client.Two.Chat.Conversations.Item;
namespace XbyOpenApi.Core.Client.Two.Chat.Conversations
{
  /// <summary>
  ...
  public partial class ConversationsRequestBuilder : BaseRequestBuilder
  {
    ...
    public global::XbyOpenApi.Core.Client.Two.Chat.Conversations.Group.GroupRequestBuilder Group
    {
    ...
    public global::XbyOpenApi.Core.Client.Two.Chat.Conversations.Item.ConversationsItemRequestBuilder this[string position]
    {
      get
      {
        ...
        return new global::XbyOpenApi.Core.Client.Two.Chat.Conversations.Item.ConversationsItemRequestBuilder(urlTplParams, RequestAdapter);
      }
    }
    /// <summary>
    /// Instantiates a new <see cref="global::XbyOpenApi.Core.Client.Two.Chat.Conversations.ConversationsRequestBuilder"/> and sets the default values.
    /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
    public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::XbyOpenApi.Core.Client.Two.Chat.Conversations.ConversationsRequestBuilder.ConversationsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
    {
#nullable restore
#else
    public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::XbyOpenApi.Core.Client.Two.Chat.Conversations.ConversationsRequestBuilder.ConversationsRequestBuilderGetQueryParameters>> requestConfiguration = default)
    ...
    /// </summary>
    /// <returns>A <see cref="global::XbyOpenApi.Core.Client.Two.Chat.Conversations.ConversationsRequestBuilder"/></returns>
    /// <param name="rawUrl">The raw URL to use for the request builder.</param>
    public global::XbyOpenApi.Core.Client.Two.Chat.Conversations.ConversationsRequestBuilder WithUrl(string rawUrl)
    {
      return new global::XbyOpenApi.Core.Client.Two.Chat.Conversations.ConversationsRequestBuilder(rawUrl, RequestAdapter);
    }
    /// <summary>
    /// Retrieves a list of Chat conversations for the authenticated user&apos;s inbox.
    /// </summary>
...
#nullable enable
      ...
      public global::XbyOpenApi.Core.Client.Two.Chat.Conversations.GetChat_conversationFieldsQueryParameterType[]? ChatConversationFields { get; set; }
#nullable restore
#else
      [QueryParameter("chat_conversation%2Efields")]
      public global::XbyOpenApi.Core.Client.Two.Chat.Conversations.GetChat_conversationFieldsQueryParameterType[] ChatConversationFields { get; set; }
...
#nullable enable
      ...
      public global::XbyOpenApi.Core.Client.Two.Chat.Conversations.GetUserFieldsQueryParameterType[]? UserFields { get; set; }
#nullable restore
#else
      [QueryParameter("user%2Efields")]
      public global::XbyOpenApi.Core.Client.Two.Chat.Conversations.GetUserFieldsQueryParameterType[] UserFields { get; set; }
