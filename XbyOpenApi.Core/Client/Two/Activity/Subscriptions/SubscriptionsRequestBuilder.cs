...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
    public RequestInformation ToDeleteRequestInformation(Action<RequestConfiguration<global::XbyOpenApi.Core.Client.Two.Activity.Subscriptions.SubscriptionsRequestBuilder.SubscriptionsRequestBuilderDeleteQueryParameters>>? requestConfiguration = default)
    {
#nullable restore
#else
    public RequestInformation ToDeleteRequestInformation(Action<RequestConfiguration<global::XbyOpenApi.Core.Client.Two.Activity.Subscriptions.SubscriptionsRequestBuilder.SubscriptionsRequestBuilderDeleteQueryParameters>> requestConfiguration = default)
