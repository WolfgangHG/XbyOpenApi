...
namespace XbyOpenApi.Core.Client.Two.Users.Search
{
  /// <summary>
  ...
  {
    /// <summary>
    /// Instantiates a new <see cref="global::XbyOpenApi.Core.Client.Two.Users.Search.SearchRequestBuilder"/> and sets the default values.
    /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::XbyOpenApi.Core.Client.Two.Users.Search.SearchRequestBuilder.SearchRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
    public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::XbyOpenApi.Core.Client.Two.Users.Search.SearchRequestBuilder.SearchRequestBuilderGetQueryParameters>> requestConfiguration = default)
    ...
    /// </summary>
    /// <returns>A <see cref="global::XbyOpenApi.Core.Client.Two.Users.Search.SearchRequestBuilder"/></returns>
    /// <param name="rawUrl">The raw URL to use for the request builder.</param>
    public global::XbyOpenApi.Core.Client.Two.Users.Search.SearchRequestBuilder WithUrl(string rawUrl)
    {
...
#nullable enable
            ...
            public global::XbyOpenApi.Core.Client.Two.Users.Search.GetUserFieldsQueryParameterType[]? UserFields { get; set; }
#nullable restore
#else
      [QueryParameter("user%2Efields")]
      public global::XbyOpenApi.Core.Client.Two.Users.Search.GetUserFieldsQueryParameterType[] UserFields { get; set; }
