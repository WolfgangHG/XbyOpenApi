...
using XbyOpenApi.Core.Client.Two.Users.Item.Following.Item;
namespace XbyOpenApi.Core.Client.Two.Users.Item.Following
{
  /// <summary>
  ...
  public partial class FollowingRequestBuilder : BaseRequestBuilder
  {
    ...
    public global::XbyOpenApi.Core.Client.Two.Users.Item.Following.Item.WithTarget_user_ItemRequestBuilder this[string position]
    {
      get
      {
        ...
        return new global::XbyOpenApi.Core.Client.Two.Users.Item.Following.Item.WithTarget_user_ItemRequestBuilder(urlTplParams, RequestAdapter);
      }
    }
    /// <summary>
    /// Instantiates a new <see cref="global::XbyOpenApi.Core.Client.Two.Users.Item.Following.FollowingRequestBuilder"/> and sets the default values.
    /// </summary>
...
#nullable restore
    ...
    /// </summary>
    /// <returns>A <see cref="global::XbyOpenApi.Core.Client.Two.Users.Item.Following.FollowingRequestBuilder"/></returns>
    /// <param name="rawUrl">The raw URL to use for the request builder.</param>
    public global::XbyOpenApi.Core.Client.Two.Users.Item.Following.FollowingRequestBuilder WithUrl(string rawUrl)
    {
...
#nullable enable
            ...
            public global::XbyOpenApi.Core.Client.Two.Users.Item.Following.GetUserFieldsQueryParameterType[]? UserFields { get; set; }
#nullable restore
#else
      [QueryParameter("user%2Efields")]
      public global::XbyOpenApi.Core.Client.Two.Users.Item.Following.GetUserFieldsQueryParameterType[] UserFields { get; set; }
