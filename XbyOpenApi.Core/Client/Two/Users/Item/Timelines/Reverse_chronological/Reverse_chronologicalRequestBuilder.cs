...
namespace XbyOpenApi.Core.Client.Two.Users.Item.Timelines.Reverse_chronological
{
  /// <summary>
  ...
  {
    /// <summary>
    /// Instantiates a new <see cref="global::XbyOpenApi.Core.Client.Two.Users.Item.Timelines.Reverse_chronological.Reverse_chronologicalRequestBuilder"/> and sets the default values.
    /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::XbyOpenApi.Core.Client.Two.Users.Item.Timelines.Reverse_chronological.Reverse_chronologicalRequestBuilder.Reverse_chronologicalRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
    public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::XbyOpenApi.Core.Client.Two.Users.Item.Timelines.Reverse_chronological.Reverse_chronologicalRequestBuilder.Reverse_chronologicalRequestBuilderGetQueryParameters>> requestConfiguration = default)
    ...
    /// </summary>
    /// <returns>A <see cref="global::XbyOpenApi.Core.Client.Two.Users.Item.Timelines.Reverse_chronological.Reverse_chronologicalRequestBuilder"/></returns>
    /// <param name="rawUrl">The raw URL to use for the request builder.</param>
    public global::XbyOpenApi.Core.Client.Two.Users.Item.Timelines.Reverse_chronological.Reverse_chronologicalRequestBuilder WithUrl(string rawUrl)
    {
...
#nullable enable
            ...
            public global::XbyOpenApi.Core.Client.Two.Users.Item.Timelines.Reverse_chronological.GetPlaceFieldsQueryParameterType[]? PlaceFields { get; set; }
#nullable restore
#else
      [QueryParameter("place%2Efields")]
      public global::XbyOpenApi.Core.Client.Two.Users.Item.Timelines.Reverse_chronological.GetPlaceFieldsQueryParameterType[] PlaceFields { get; set; }
...
#nullable enable
            ...
            public global::XbyOpenApi.Core.Client.Two.Users.Item.Timelines.Reverse_chronological.GetUserFieldsQueryParameterType[]? UserFields { get; set; }
#nullable restore
#else
      [QueryParameter("user%2Efields")]
      public global::XbyOpenApi.Core.Client.Two.Users.Item.Timelines.Reverse_chronological.GetUserFieldsQueryParameterType[] UserFields { get; set; }
