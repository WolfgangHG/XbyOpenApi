...
using XbyOpenApi.Core.Client.Two.Lists.Item;
namespace XbyOpenApi.Core.Client.Two.Lists
{
  /// <summary>
  /// Builds and executes requests for operations under \2\lists
  /// </summary>
  ...
  public partial class ListsRequestBuilder : BaseRequestBuilder
  {
    ...
    public global::XbyOpenApi.Core.Client.Two.Lists.Item.ListsItemRequestBuilder this[string position]
    {
      get
      {
        ...
        return new global::XbyOpenApi.Core.Client.Two.Lists.Item.ListsItemRequestBuilder(urlTplParams, RequestAdapter);
      }
    }
    /// <summary>
    /// Instantiates a new <see cref="global::XbyOpenApi.Core.Client.Two.Lists.ListsRequestBuilder"/> and sets the default values.
    /// </summary>
    /// <param name="pathParameters">Path parameters for the request</param>
    /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
    public ListsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/2/lists", pathParameters)
    {
    }
    /// <summary>
    /// Instantiates a new <see cref="global::XbyOpenApi.Core.Client.Two.Lists.ListsRequestBuilder"/> and sets the default values.
    ...
    /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
    public ListsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/2/lists", rawUrl)
    {
    }
    /// <summary>
...
#nullable restore
    ...
    /// </summary>
    /// <returns>A <see cref="global::XbyOpenApi.Core.Client.Two.Lists.ListsRequestBuilder"/></returns>
    /// <param name="rawUrl">The raw URL to use for the request builder.</param>
    public global::XbyOpenApi.Core.Client.Two.Lists.ListsRequestBuilder WithUrl(string rawUrl)
    {
      return new global::XbyOpenApi.Core.Client.Two.Lists.ListsRequestBuilder(rawUrl, RequestAdapter);
    }
  }
}
