...
namespace XbyOpenApi.Core.Client.Two.Spaces.Item.Tweets
{
  /// <summary>
  ...
  {
    /// <summary>
    /// Instantiates a new <see cref="global::XbyOpenApi.Core.Client.Two.Spaces.Item.Tweets.TweetsRequestBuilder"/> and sets the default values.
    /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::XbyOpenApi.Core.Client.Two.Spaces.Item.Tweets.TweetsRequestBuilder.TweetsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
    public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::XbyOpenApi.Core.Client.Two.Spaces.Item.Tweets.TweetsRequestBuilder.TweetsRequestBuilderGetQueryParameters>> requestConfiguration = default)
    ...
    /// </summary>
    /// <returns>A <see cref="global::XbyOpenApi.Core.Client.Two.Spaces.Item.Tweets.TweetsRequestBuilder"/></returns>
    /// <param name="rawUrl">The raw URL to use for the request builder.</param>
    public global::XbyOpenApi.Core.Client.Two.Spaces.Item.Tweets.TweetsRequestBuilder WithUrl(string rawUrl)
    {
      return new global::XbyOpenApi.Core.Client.Two.Spaces.Item.Tweets.TweetsRequestBuilder(rawUrl, RequestAdapter);
    }
    /// <summary>
    /// Retrieves a list of Posts shared in a specific Space by its ID.
    /// </summary>
...
#nullable enable
            ...
            public global::XbyOpenApi.Core.Client.Two.Spaces.Item.Tweets.GetPlaceFieldsQueryParameterType[]? PlaceFields { get; set; }
#nullable restore
#else
      [QueryParameter("place%2Efields")]
      public global::XbyOpenApi.Core.Client.Two.Spaces.Item.Tweets.GetPlaceFieldsQueryParameterType[] PlaceFields { get; set; }
...
#nullable enable
            ...
            public global::XbyOpenApi.Core.Client.Two.Spaces.Item.Tweets.GetUserFieldsQueryParameterType[]? UserFields { get; set; }
#nullable restore
#else
      [QueryParameter("user%2Efields")]
      public global::XbyOpenApi.Core.Client.Two.Spaces.Item.Tweets.GetUserFieldsQueryParameterType[] UserFields { get; set; }
