...
namespace XbyOpenApi.Core.Client.Two.Tweets.Analytics
{
  ...
  public partial class AnalyticsRequestBuilder : BaseRequestBuilder
  {
    ...
    /// </summary>
    /// <returns>A <see cref="global::XbyOpenApi.Core.Client.Models.Analytics"/></returns>
...
#nullable restore
    ...
    public async Task<global::XbyOpenApi.Core.Client.Models.Analytics> GetAsync(Action<RequestConfiguration<global::XbyOpenApi.Core.Client.Two.Tweets.Analytics.AnalyticsRequestBuilder.AnalyticsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
    {
      ...
      return await RequestAdapter.SendAsync<global::XbyOpenApi.Core.Client.Models.Analytics>(requestInfo, global::XbyOpenApi.Core.Client.Models.Analytics.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
    }
    /// <summary>
    /// Retrieves analytics data for specified Posts within a defined time range.
    /// </summary>
