...
namespace XbyOpenApi.Core.Client.Two.Tweets.Counts.All
{
  /// <summary>
  /// Builds and executes requests for operations under \2\tweets\counts\all
  /// </summary>
  [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
  public partial class AllRequestBuilder : BaseRequestBuilder
  {
    /// <summary>
    /// Instantiates a new <see cref="global::XbyOpenApi.Core.Client.Two.Tweets.Counts.All.AllRequestBuilder"/> and sets the default values.
    /// </summary>
...
#nullable enable
    public async Task<global::XbyOpenApi.Core.Client.Models.GetPostsCountsAllResponse?> GetAsync(Action<RequestConfiguration<global::XbyOpenApi.Core.Client.Two.Tweets.Counts.All.AllRequestBuilder.AllRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
    {
#nullable restore
#else
    public async Task<global::XbyOpenApi.Core.Client.Models.GetPostsCountsAllResponse> GetAsync(Action<RequestConfiguration<global::XbyOpenApi.Core.Client.Two.Tweets.Counts.All.AllRequestBuilder.AllRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
    {
      ...
      return await RequestAdapter.SendAsync<global::XbyOpenApi.Core.Client.Models.GetPostsCountsAllResponse>(requestInfo, global::XbyOpenApi.Core.Client.Models.GetPostsCountsAllResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
    }
    /// <summary>
    /// At most one of `pagination_token`, `next_token` may be provided.
    /// </summary>
...
#nullable restore
    ...
    /// </summary>
    /// <returns>A <see cref="global::XbyOpenApi.Core.Client.Two.Tweets.Counts.All.AllRequestBuilder"/></returns>
    /// <param name="rawUrl">The raw URL to use for the request builder.</param>
    public global::XbyOpenApi.Core.Client.Two.Tweets.Counts.All.AllRequestBuilder WithUrl(string rawUrl)
    {
      return new global::XbyOpenApi.Core.Client.Two.Tweets.Counts.All.AllRequestBuilder(rawUrl, RequestAdapter);
    }
    /// <summary>
    /// At most one of `pagination_token`, `next_token` may be provided.
    /// </summary>
    ...
    public partial class AllRequestBuilderGetQueryParameters
    {
      ...
      public global::XbyOpenApi.Core.Client.Two.Tweets.Counts.All.GetGranularityQueryParameterType? Granularity { get; set; }
