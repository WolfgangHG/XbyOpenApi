...
namespace XbyOpenApi.Core.Client.Two.Tweets.Search.StreamNamespace.Rules.Counts
{
  /// <summary>
  ...
  {
    /// <summary>
    /// Instantiates a new <see cref="global::XbyOpenApi.Core.Client.Two.Tweets.Search.StreamNamespace.Rules.Counts.CountsRequestBuilder"/> and sets the default values.
    /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::XbyOpenApi.Core.Client.Two.Tweets.Search.StreamNamespace.Rules.Counts.CountsRequestBuilder.CountsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
    public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::XbyOpenApi.Core.Client.Two.Tweets.Search.StreamNamespace.Rules.Counts.CountsRequestBuilder.CountsRequestBuilderGetQueryParameters>> requestConfiguration = default)
    ...
    /// </summary>
    /// <returns>A <see cref="global::XbyOpenApi.Core.Client.Two.Tweets.Search.StreamNamespace.Rules.Counts.CountsRequestBuilder"/></returns>
    /// <param name="rawUrl">The raw URL to use for the request builder.</param>
    public global::XbyOpenApi.Core.Client.Two.Tweets.Search.StreamNamespace.Rules.Counts.CountsRequestBuilder WithUrl(string rawUrl)
    {
