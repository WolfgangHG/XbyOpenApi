...
namespace XbyOpenApi.Core.Client.Two.Tweets.Search.Webhooks.Item
{
  /// <summary>
  ...
  {
    /// <summary>
    /// Instantiates a new <see cref="global::XbyOpenApi.Core.Client.Two.Tweets.Search.Webhooks.Item.WithWebhook_ItemRequestBuilder"/> and sets the default values.
    /// </summary>
