...
namespace XbyOpenApi.Core.Client.Two.Tweets.Sample.StreamNamespace
{
  /// <summary>
  /// Builds and executes requests for operations under \2\tweets\sample\stream
  /// </summary>
  [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
  public partial class StreamRequestBuilder : BaseRequestBuilder
  {
    /// <summary>
    /// Instantiates a new <see cref="global::XbyOpenApi.Core.Client.Two.Tweets.Sample.StreamNamespace.StreamRequestBuilder"/> and sets the default values.
    /// </summary>
    /// <param name="pathParameters">Path parameters for the request</param>
    /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
    public StreamRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/2/tweets/sample/stream{?backfill_minutes*,expansions,media%2Efields,place%2Efields,poll%2Efields,tweet%2Efields,user%2Efields}", pathParameters)
    {
    }
    /// <summary>
    /// Instantiates a new <see cref="global::XbyOpenApi.Core.Client.Two.Tweets.Sample.StreamNamespace.StreamRequestBuilder"/> and sets the default values.
    ...
    /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
    public StreamRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/2/tweets/sample/stream{?backfill_minutes*,expansions,media%2Efields,place%2Efields,poll%2Efields,tweet%2Efields,user%2Efields}", rawUrl)
    {
    }
    /// <summary>
    /// Streams a 1% sample of public Posts in real-time.
    /// </summary>
    /// <returns>A <see cref="global::XbyOpenApi.Core.Client.Models.StreamPostsSampleResponse"/></returns>
...
#nullable enable
    public async Task<global::XbyOpenApi.Core.Client.Models.StreamPostsSampleResponse?> GetAsync(Action<RequestConfiguration<global::XbyOpenApi.Core.Client.Two.Tweets.Sample.StreamNamespace.StreamRequestBuilder.StreamRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
    {
#nullable restore
#else
    public async Task<global::XbyOpenApi.Core.Client.Models.StreamPostsSampleResponse> GetAsync(Action<RequestConfiguration<global::XbyOpenApi.Core.Client.Two.Tweets.Sample.StreamNamespace.StreamRequestBuilder.StreamRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
    {
      ...
      return await RequestAdapter.SendAsync<global::XbyOpenApi.Core.Client.Models.StreamPostsSampleResponse>(requestInfo, global::XbyOpenApi.Core.Client.Models.StreamPostsSampleResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
    }
    /// <summary>
    /// Streams a 1% sample of public Posts in real-time.
    /// </summary>
...
#nullable restore
    ...
    /// </summary>
    /// <returns>A <see cref="global::XbyOpenApi.Core.Client.Two.Tweets.Sample.StreamNamespace.StreamRequestBuilder"/></returns>
    /// <param name="rawUrl">The raw URL to use for the request builder.</param>
    public global::XbyOpenApi.Core.Client.Two.Tweets.Sample.StreamNamespace.StreamRequestBuilder WithUrl(string rawUrl)
    {
      return new global::XbyOpenApi.Core.Client.Two.Tweets.Sample.StreamNamespace.StreamRequestBuilder(rawUrl, RequestAdapter);
    }
    /// <summary>
    /// Streams a 1% sample of public Posts in real-time.
    /// </summary>
