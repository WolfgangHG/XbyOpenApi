...
namespace XbyOpenApi.Core.Client.Two.Tweets.Sample10.StreamNamespace
{
  /// <summary>
  /// Builds and executes requests for operations under \2\tweets\sample10\stream
  /// </summary>
  [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
  public partial class StreamRequestBuilder : BaseRequestBuilder
  {
    /// <summary>
    /// Instantiates a new <see cref="global::XbyOpenApi.Core.Client.Two.Tweets.Sample10.StreamNamespace.StreamRequestBuilder"/> and sets the default values.
    /// </summary>
    /// <param name="pathParameters">Path parameters for the request</param>
    /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
    public StreamRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/2/tweets/sample10/stream?partition={partition}{&backfill_minutes*,end_time*,expansions,media%2Efields,place%2Efields,poll%2Efields,start_time*,tweet%2Efields,user%2Efields}", pathParameters)
    {
    }
    /// <summary>
    /// Instantiates a new <see cref="global::XbyOpenApi.Core.Client.Two.Tweets.Sample10.StreamNamespace.StreamRequestBuilder"/> and sets the default values.
    ...
    /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
    public StreamRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/2/tweets/sample10/stream?partition={partition}{&backfill_minutes*,end_time*,expansions,media%2Efields,place%2Efields,poll%2Efields,start_time*,tweet%2Efields,user%2Efields}", rawUrl)
    {
    }
    /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::XbyOpenApi.Core.Client.Two.Tweets.Sample10.StreamNamespace.StreamRequestBuilder.StreamRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
    public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::XbyOpenApi.Core.Client.Two.Tweets.Sample10.StreamNamespace.StreamRequestBuilder.StreamRequestBuilderGetQueryParameters>> requestConfiguration = default)
    ...
    /// </summary>
    /// <returns>A <see cref="global::XbyOpenApi.Core.Client.Two.Tweets.Sample10.StreamNamespace.StreamRequestBuilder"/></returns>
    /// <param name="rawUrl">The raw URL to use for the request builder.</param>
    public global::XbyOpenApi.Core.Client.Two.Tweets.Sample10.StreamNamespace.StreamRequestBuilder WithUrl(string rawUrl)
    {
      return new global::XbyOpenApi.Core.Client.Two.Tweets.Sample10.StreamNamespace.StreamRequestBuilder(rawUrl, RequestAdapter);
    }
    /// <summary>
    /// Streams a 10% sample of public Posts in real-time.
    /// </summary>
...
#nullable enable
            ...
            public global::XbyOpenApi.Core.Client.Two.Tweets.Sample10.StreamNamespace.GetExpansionsQueryParameterType[]? Expansions { get; set; }
#nullable restore
#else
      [QueryParameter("expansions")]
      public global::XbyOpenApi.Core.Client.Two.Tweets.Sample10.StreamNamespace.GetExpansionsQueryParameterType[] Expansions { get; set; }
...
#nullable enable
            ...
            public global::XbyOpenApi.Core.Client.Two.Tweets.Sample10.StreamNamespace.GetMediaFieldsQueryParameterType[]? MediaFields { get; set; }
#nullable restore
#else
      [QueryParameter("media%2Efields")]
      public global::XbyOpenApi.Core.Client.Two.Tweets.Sample10.StreamNamespace.GetMediaFieldsQueryParameterType[] MediaFields { get; set; }
...
#nullable enable
            ...
            public global::XbyOpenApi.Core.Client.Two.Tweets.Sample10.StreamNamespace.GetPlaceFieldsQueryParameterType[]? PlaceFields { get; set; }
#nullable restore
#else
      [QueryParameter("place%2Efields")]
      public global::XbyOpenApi.Core.Client.Two.Tweets.Sample10.StreamNamespace.GetPlaceFieldsQueryParameterType[] PlaceFields { get; set; }
...
#nullable enable
            ...
            public global::XbyOpenApi.Core.Client.Two.Tweets.Sample10.StreamNamespace.GetPollFieldsQueryParameterType[]? PollFields { get; set; }
#nullable restore
#else
      [QueryParameter("poll%2Efields")]
      public global::XbyOpenApi.Core.Client.Two.Tweets.Sample10.StreamNamespace.GetPollFieldsQueryParameterType[] PollFields { get; set; }
...
#nullable enable
            ...
            public global::XbyOpenApi.Core.Client.Two.Tweets.Sample10.StreamNamespace.GetTweetFieldsQueryParameterType[]? TweetFields { get; set; }
#nullable restore
#else
      [QueryParameter("tweet%2Efields")]
      public global::XbyOpenApi.Core.Client.Two.Tweets.Sample10.StreamNamespace.GetTweetFieldsQueryParameterType[] TweetFields { get; set; }
...
#nullable enable
            ...
            public global::XbyOpenApi.Core.Client.Two.Tweets.Sample10.StreamNamespace.GetUserFieldsQueryParameterType[]? UserFields { get; set; }
#nullable restore
#else
      [QueryParameter("user%2Efields")]
      public global::XbyOpenApi.Core.Client.Two.Tweets.Sample10.StreamNamespace.GetUserFieldsQueryParameterType[] UserFields { get; set; }
