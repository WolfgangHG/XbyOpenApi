...
namespace XbyOpenApi.Core.Client.Two.Tweets.Item.Quote_tweets
{
  /// <summary>
  ...
  {
    /// <summary>
    /// Instantiates a new <see cref="global::XbyOpenApi.Core.Client.Two.Tweets.Item.Quote_tweets.Quote_tweetsRequestBuilder"/> and sets the default values.
    /// </summary>
...
#nullable enable
    public async Task<global::XbyOpenApi.Core.Client.Models.GetPostsQuotedPostsResponse?> GetAsync(Action<RequestConfiguration<global::XbyOpenApi.Core.Client.Two.Tweets.Item.Quote_tweets.Quote_tweetsRequestBuilder.Quote_tweetsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
    {
#nullable restore
#else
    public async Task<global::XbyOpenApi.Core.Client.Models.GetPostsQuotedPostsResponse> GetAsync(Action<RequestConfiguration<global::XbyOpenApi.Core.Client.Two.Tweets.Item.Quote_tweets.Quote_tweetsRequestBuilder.Quote_tweetsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
    {
      ...
      return await RequestAdapter.SendAsync<global::XbyOpenApi.Core.Client.Models.GetPostsQuotedPostsResponse>(requestInfo, global::XbyOpenApi.Core.Client.Models.GetPostsQuotedPostsResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
    }
    /// <summary>
    /// Get Posts Quoted Posts
    /// </summary>
...
#nullable restore
    ...
    /// </summary>
    /// <returns>A <see cref="global::XbyOpenApi.Core.Client.Two.Tweets.Item.Quote_tweets.Quote_tweetsRequestBuilder"/></returns>
    /// <param name="rawUrl">The raw URL to use for the request builder.</param>
    public global::XbyOpenApi.Core.Client.Two.Tweets.Item.Quote_tweets.Quote_tweetsRequestBuilder WithUrl(string rawUrl)
    {
      return new global::XbyOpenApi.Core.Client.Two.Tweets.Item.Quote_tweets.Quote_tweetsRequestBuilder(rawUrl, RequestAdapter);
    }
    /// <summary>
    /// Get Posts Quoted Posts
    /// </summary>
...
#nullable enable
      ...
      public global::XbyOpenApi.Core.Client.Two.Tweets.Item.Quote_tweets.GetPostFieldsQueryParameterType[]? PostFields { get; set; }
#nullable restore
#else
      [QueryParameter("post%2Efields")]
      public global::XbyOpenApi.Core.Client.Two.Tweets.Item.Quote_tweets.GetPostFieldsQueryParameterType[] PostFields { get; set; }
