...
namespace XbyOpenApi.Core.Client.Two.Likes.Firehose.StreamNamespace
{
  ...
  public partial class StreamRequestBuilder : BaseRequestBuilder
  {
    ...
    public StreamRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/2/likes/firehose/stream?partition={partition}{&backfill_minutes*,end_time*,expansions,like_with_tweet_author%2Efields,start_time*,tweet%2Efields,user%2Efields}", pathParameters)
    {
    }
    /// <summary>
    /// Instantiates a new <see cref="global::XbyOpenApi.Core.Client.Two.Likes.Firehose.StreamNamespace.StreamRequestBuilder"/> and sets the default values.
    ...
    /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
    public StreamRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/2/likes/firehose/stream?partition={partition}{&backfill_minutes*,end_time*,expansions,like_with_tweet_author%2Efields,start_time*,tweet%2Efields,user%2Efields}", rawUrl)
    {
    }
    /// <summary>
