...
using XbyOpenApi.Core.Client.Two.Dm_events.Item;
namespace XbyOpenApi.Core.Client.Two.Dm_events
{
  /// <summary>
  /// Builds and executes requests for operations under \2\dm_events
  /// </summary>
  ...
  public partial class Dm_eventsRequestBuilder : BaseRequestBuilder
  {
    ...
    public global::XbyOpenApi.Core.Client.Two.Dm_events.Item.WithEvent_ItemRequestBuilder this[string position]
    {
      get
      {
        ...
        return new global::XbyOpenApi.Core.Client.Two.Dm_events.Item.WithEvent_ItemRequestBuilder(urlTplParams, RequestAdapter);
      }
    }
    /// <summary>
    /// Instantiates a new <see cref="global::XbyOpenApi.Core.Client.Two.Dm_events.Dm_eventsRequestBuilder"/> and sets the default values.
    /// </summary>
...
#nullable restore
    ...
    /// </summary>
    /// <returns>A <see cref="global::XbyOpenApi.Core.Client.Two.Dm_events.Dm_eventsRequestBuilder"/></returns>
    /// <param name="rawUrl">The raw URL to use for the request builder.</param>
    public global::XbyOpenApi.Core.Client.Two.Dm_events.Dm_eventsRequestBuilder WithUrl(string rawUrl)
    {
