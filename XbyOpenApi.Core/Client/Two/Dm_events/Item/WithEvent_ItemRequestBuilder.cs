...
namespace XbyOpenApi.Core.Client.Two.Dm_events.Item
{
  ...
  {
    /// <summary>
    /// Instantiates a new <see cref="global::XbyOpenApi.Core.Client.Two.Dm_events.Item.WithEvent_ItemRequestBuilder"/> and sets the default values.
    /// </summary>
...
#nullable restore
    ...
    /// <param name="rawUrl">The raw URL to use for the request builder.</param>
    public global::XbyOpenApi.Core.Client.Two.Dm_events.Item.WithEvent_ItemRequestBuilder WithUrl(string rawUrl)
    {
...
#nullable enable
            ...
            public global::XbyOpenApi.Core.Client.Two.Dm_events.Item.GetDm_eventFieldsQueryParameterType[]? DmEventFields { get; set; }
#nullable restore
#else
      [QueryParameter("dm_event%2Efields")]
      public global::XbyOpenApi.Core.Client.Two.Dm_events.Item.GetDm_eventFieldsQueryParameterType[] DmEventFields { get; set; }
...
#nullable enable
            ...
            public global::XbyOpenApi.Core.Client.Two.Dm_events.Item.GetExpansionsQueryParameterType[]? Expansions { get; set; }
#nullable restore
#else
      [QueryParameter("expansions")]
      public global::XbyOpenApi.Core.Client.Two.Dm_events.Item.GetExpansionsQueryParameterType[] Expansions { get; set; }
...
#nullable enable
            ...
            public global::XbyOpenApi.Core.Client.Two.Dm_events.Item.GetUserFieldsQueryParameterType[]? UserFields { get; set; }
#nullable restore
#else
      [QueryParameter("user%2Efields")]
      public global::XbyOpenApi.Core.Client.Two.Dm_events.Item.GetUserFieldsQueryParameterType[] UserFields { get; set; }
