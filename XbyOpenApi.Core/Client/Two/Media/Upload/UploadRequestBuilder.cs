...
using XbyOpenApi.Core.Client.Two.Media.Upload.Initialize;
using XbyOpenApi.Core.Client.Two.Media.Upload.Item;
namespace XbyOpenApi.Core.Client.Two.Media.Upload
{
  /// <summary>
  ...
  public partial class UploadRequestBuilder : BaseRequestBuilder
  {
    ...
    public global::XbyOpenApi.Core.Client.Two.Media.Upload.Initialize.InitializeRequestBuilder Initialize
    {
    ...
    public global::XbyOpenApi.Core.Client.Two.Media.Upload.Item.UploadItemRequestBuilder this[string position]
    {
      get
      {
        ...
        return new global::XbyOpenApi.Core.Client.Two.Media.Upload.Item.UploadItemRequestBuilder(urlTplParams, RequestAdapter);
      }
    }
    /// <summary>
    /// Instantiates a new <see cref="global::XbyOpenApi.Core.Client.Two.Media.Upload.UploadRequestBuilder"/> and sets the default values.
    /// </summary>
...
#nullable restore
    ...
    {
#endif
      var requestInfo = new RequestInformation(Method.GET, "{+baseurl}/2/media/upload?media_id={media_id}{&command*}", PathParameters);
...
#nullable restore
    ...
    /// </summary>
    /// <returns>A <see cref="global::XbyOpenApi.Core.Client.Two.Media.Upload.UploadRequestBuilder"/></returns>
    /// <param name="rawUrl">The raw URL to use for the request builder.</param>
    public global::XbyOpenApi.Core.Client.Two.Media.Upload.UploadRequestBuilder WithUrl(string rawUrl)
    {
      return new global::XbyOpenApi.Core.Client.Two.Media.Upload.UploadRequestBuilder(rawUrl, RequestAdapter);
    }
    /// <summary>
    /// Retrieves the status of a Media upload by its ID.
    /// </summary>
