...
namespace XbyOpenApi.Core.Client.Two.Notes.Search.Posts_eligible_for_notes
{
  /// <summary>
  ...
  {
    /// <summary>
    /// Instantiates a new <see cref="global::XbyOpenApi.Core.Client.Two.Notes.Search.Posts_eligible_for_notes.Posts_eligible_for_notesRequestBuilder"/> and sets the default values.
    /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::XbyOpenApi.Core.Client.Two.Notes.Search.Posts_eligible_for_notes.Posts_eligible_for_notesRequestBuilder.Posts_eligible_for_notesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
    public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::XbyOpenApi.Core.Client.Two.Notes.Search.Posts_eligible_for_notes.Posts_eligible_for_notesRequestBuilder.Posts_eligible_for_notesRequestBuilderGetQueryParameters>> requestConfiguration = default)
    ...
    /// </summary>
    /// <returns>A <see cref="global::XbyOpenApi.Core.Client.Two.Notes.Search.Posts_eligible_for_notes.Posts_eligible_for_notesRequestBuilder"/></returns>
    /// <param name="rawUrl">The raw URL to use for the request builder.</param>
    public global::XbyOpenApi.Core.Client.Two.Notes.Search.Posts_eligible_for_notes.Posts_eligible_for_notesRequestBuilder WithUrl(string rawUrl)
    {
...
#nullable enable
            ...
            public global::XbyOpenApi.Core.Client.Two.Notes.Search.Posts_eligible_for_notes.GetPlaceFieldsQueryParameterType[]? PlaceFields { get; set; }
#nullable restore
#else
      [QueryParameter("place%2Efields")]
      public global::XbyOpenApi.Core.Client.Two.Notes.Search.Posts_eligible_for_notes.GetPlaceFieldsQueryParameterType[] PlaceFields { get; set; }
...
#nullable enable
            ...
            public global::XbyOpenApi.Core.Client.Two.Notes.Search.Posts_eligible_for_notes.GetUserFieldsQueryParameterType[]? UserFields { get; set; }
#nullable restore
#else
      [QueryParameter("user%2Efields")]
      public global::XbyOpenApi.Core.Client.Two.Notes.Search.Posts_eligible_for_notes.GetUserFieldsQueryParameterType[] UserFields { get; set; }
