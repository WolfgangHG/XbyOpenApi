...
namespace XbyOpenApi.Core.Client.Two.Notes.Item
{
  /// <summary>
  ...
  {
    /// <summary>
    /// Instantiates a new <see cref="global::XbyOpenApi.Core.Client.Two.Notes.Item.NotesItemRequestBuilder"/> and sets the default values.
    /// </summary>
    /// <param name="pathParameters">Path parameters for the request</param>
    /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
    public NotesItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/2/notes/{id}", pathParameters)
    {
    }
    /// <summary>
    /// Instantiates a new <see cref="global::XbyOpenApi.Core.Client.Two.Notes.Item.NotesItemRequestBuilder"/> and sets the default values.
    ...
    /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
    public NotesItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/2/notes/{id}", rawUrl)
    {
    }
    /// <summary>
...
#nullable restore
    ...
    /// <param name="rawUrl">The raw URL to use for the request builder.</param>
    public global::XbyOpenApi.Core.Client.Two.Notes.Item.NotesItemRequestBuilder WithUrl(string rawUrl)
    {
      return new global::XbyOpenApi.Core.Client.Two.Notes.Item.NotesItemRequestBuilder(rawUrl, RequestAdapter);
    }
  }
}
