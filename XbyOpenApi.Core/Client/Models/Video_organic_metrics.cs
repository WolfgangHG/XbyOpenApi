...
namespace XbyOpenApi.Core.Client.Models
{
  ...
  public partial class Video_organic_metrics : IAdditionalDataHolder, IParsable
  {
    ...
    /// <summary>
    /// Instantiates a new <see cref="global::XbyOpenApi.Core.Client.Models.Video_organic_metrics"/> and sets the default values.
    /// </summary>
    ...
    /// </summary>
    /// <returns>A <see cref="global::XbyOpenApi.Core.Client.Models.Video_organic_metrics"/></returns>
    /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
    public static global::XbyOpenApi.Core.Client.Models.Video_organic_metrics CreateFromDiscriminatorValue(IParseNode parseNode)
    {
      if (ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
      return new global::XbyOpenApi.Core.Client.Models.Video_organic_metrics();
    }
    /// <summary>
