...
#nullable restore
    ...
    /// <summary>
    /// Instantiates a new <see cref="global::XbyOpenApi.Core.Client.Models.RulesCount"/> and sets the default values.
    /// </summary>
    public RulesCount()
    {
    ...
    /// </summary>
    /// <returns>A <see cref="global::XbyOpenApi.Core.Client.Models.RulesCount"/></returns>
    /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
    public static global::XbyOpenApi.Core.Client.Models.RulesCount CreateFromDiscriminatorValue(IParseNode parseNode)
    {
      if (ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
      return new global::XbyOpenApi.Core.Client.Models.RulesCount();
    }
    /// <summary>
    ...
    public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
    {
      return new Dictionary<string, Action<IParseNode>>
            {
                { "all_project_client_apps", n => { AllProjectClientApps = n.GetCollectionOfObjectValues<global::XbyOpenApi.Core.Client.Models.AppRulesCount>(global::XbyOpenApi.Core.Client.Models.AppRulesCount.CreateFromDiscriminatorValue)?.AsList(); } },
                { "cap_per_client_app", n => { CapPerClientApp = n.GetIntValue(); } },
                { "cap_per_project", n => { CapPerProject = n.GetIntValue(); } },
                { "client_app_rules_count", n => { ClientAppRulesCount = n.GetObjectValue<global::XbyOpenApi.Core.Client.Models.AppRulesCount>(global::XbyOpenApi.Core.Client.Models.AppRulesCount.CreateFromDiscriminatorValue); } },
    ...
    public virtual void Serialize(ISerializationWriter writer)
    {
      ...
      writer.WriteCollectionOfObjectValues<global::XbyOpenApi.Core.Client.Models.AppRulesCount>("all_project_client_apps", AllProjectClientApps);
      writer.WriteIntValue("cap_per_client_app", CapPerClientApp);
      writer.WriteIntValue("cap_per_project", CapPerProject);
      writer.WriteObjectValue<global::XbyOpenApi.Core.Client.Models.AppRulesCount>("client_app_rules_count", ClientAppRulesCount);
