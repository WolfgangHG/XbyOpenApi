...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
    public List<global::XbyOpenApi.Core.Client.Models.Analytics>? TimestampedMetrics { get; set; }
#nullable restore
#else
    public List<global::XbyOpenApi.Core.Client.Models.Analytics> TimestampedMetrics { get; set; }
#endif
    ...
    /// <summary>
    /// Instantiates a new <see cref="global::XbyOpenApi.Core.Client.Models.MediaAnalytics"/> and sets the default values.
    /// </summary>
    ...
    public static global::XbyOpenApi.Core.Client.Models.MediaAnalytics CreateFromDiscriminatorValue(IParseNode parseNode)
    {
      if (ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
      return new global::XbyOpenApi.Core.Client.Models.MediaAnalytics();
    }
    /// <summary>
      ...
      return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "timestamped_metrics", n => { TimestampedMetrics = n.GetCollectionOfObjectValues<global::XbyOpenApi.Core.Client.Models.Analytics>(global::XbyOpenApi.Core.Client.Models.Analytics.CreateFromDiscriminatorValue)?.AsList(); } },
    ...
    public virtual void Serialize(ISerializationWriter writer)
    {
      ...
      writer.WriteCollectionOfObjectValues<global::XbyOpenApi.Core.Client.Models.Analytics>("timestamped_metrics", TimestampedMetrics);
