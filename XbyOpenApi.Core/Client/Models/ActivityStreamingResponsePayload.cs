...
#nullable restore
    ...
    /// </summary>
    /// <returns>A <see cref="global::XbyOpenApi.Core.Client.Models.ActivityStreamingResponsePayload"/></returns>
    /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
    public static global::XbyOpenApi.Core.Client.Models.ActivityStreamingResponsePayload CreateFromDiscriminatorValue(IParseNode parseNode)
    {
      if (ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
      var mappingValue = parseNode.GetChildNode("../event_type")?.GetStringValue();
      var result = new global::XbyOpenApi.Core.Client.Models.ActivityStreamingResponsePayload();
    ...
    public virtual void Serialize(ISerializationWriter writer)
    {
      ...
      {
        writer.WriteObjectValue<global::XbyOpenApi.Core.Client.Models.ProfileUpdateActivityResponsePayload>(null, ProfileUpdateActivityResponsePayload);
      }
    }
  }
}
