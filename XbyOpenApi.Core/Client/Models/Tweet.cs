...
#nullable restore
    ...
    public global::XbyOpenApi.Core.Client.Models.ReplySettingsWithVerifiedUsers? ReplySettings { get; set; }
...
#nullable restore
...
#endif
    /// <summary>
    /// Instantiates a new <see cref="global::XbyOpenApi.Core.Client.Models.Tweet"/> and sets the default values.
    /// </summary>
    public Tweet()
    {
    ...
    /// </summary>
    /// <returns>A <see cref="global::XbyOpenApi.Core.Client.Models.Tweet"/></returns>
    /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
    public static global::XbyOpenApi.Core.Client.Models.Tweet CreateFromDiscriminatorValue(IParseNode parseNode)
    {
      if (ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
      return new global::XbyOpenApi.Core.Client.Models.Tweet();
    }
    /// <summary>
    ...
    public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
    {
      return new Dictionary<string, Action<IParseNode>>
            {
                { "attachments", n => { Attachments = n.GetObjectValue<global::XbyOpenApi.Core.Client.Models.Tweet_attachments>(global::XbyOpenApi.Core.Client.Models.Tweet_attachments.CreateFromDiscriminatorValue); } },
                { "author_id", n => { AuthorId = n.GetStringValue(); } },
                { "community_id", n => { CommunityId = n.GetStringValue(); } },
                { "context_annotations", n => { ContextAnnotations = n.GetCollectionOfObjectValues<global::XbyOpenApi.Core.Client.Models.ContextAnnotation>(global::XbyOpenApi.Core.Client.Models.ContextAnnotation.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "edit_controls", n => { EditControls = n.GetObjectValue<global::XbyOpenApi.Core.Client.Models.Tweet_edit_controls>(global::XbyOpenApi.Core.Client.Models.Tweet_edit_controls.CreateFromDiscriminatorValue); } },
                { "edit_history_tweet_ids", n => { EditHistoryTweetIds = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "entities", n => { Entities = n.GetObjectValue<global::XbyOpenApi.Core.Client.Models.FullTextEntities>(global::XbyOpenApi.Core.Client.Models.FullTextEntities.CreateFromDiscriminatorValue); } },
                { "geo", n => { Geo = n.GetObjectValue<global::XbyOpenApi.Core.Client.Models.Tweet_geo>(global::XbyOpenApi.Core.Client.Models.Tweet_geo.CreateFromDiscriminatorValue); } },
                ...
                { "referenced_tweets", n => { ReferencedTweets = n.GetCollectionOfObjectValues<global::XbyOpenApi.Core.Client.Models.Tweet_referenced_tweets>(global::XbyOpenApi.Core.Client.Models.Tweet_referenced_tweets.CreateFromDiscriminatorValue)?.AsList(); } },
                { "reply_settings", n => { ReplySettings = n.GetEnumValue<global::XbyOpenApi.Core.Client.Models.ReplySettingsWithVerifiedUsers>(); } },
                { "scopes", n => { Scopes = n.GetObjectValue<global::XbyOpenApi.Core.Client.Models.Tweet_scopes>(global::XbyOpenApi.Core.Client.Models.Tweet_scopes.CreateFromDiscriminatorValue); } },
                { "source", n => { Source = n.GetStringValue(); } },
                { "suggested_source_links", n => { SuggestedSourceLinks = n.GetCollectionOfObjectValues<global::XbyOpenApi.Core.Client.Models.UrlEntity>(global::XbyOpenApi.Core.Client.Models.UrlEntity.CreateFromDiscriminatorValue)?.AsList(); } },
                { "suggested_source_links_with_counts", n => { SuggestedSourceLinksWithCounts = n.GetObjectValue<global::XbyOpenApi.Core.Client.Models.Tweet_suggested_source_links_with_counts>(global::XbyOpenApi.Core.Client.Models.Tweet_suggested_source_links_with_counts.CreateFromDiscriminatorValue); } },
                { "text", n => { Text = n.GetStringValue(); } },
                { "username", n => { Username = n.GetStringValue(); } },
                { "withheld", n => { Withheld = n.GetObjectValue<global::XbyOpenApi.Core.Client.Models.TweetWithheld>(global::XbyOpenApi.Core.Client.Models.TweetWithheld.CreateFromDiscriminatorValue); } },
            };
    }
    /// <summary>
    ...
    public virtual void Serialize(ISerializationWriter writer)
    {
      ...
      writer.WriteObjectValue<global::XbyOpenApi.Core.Client.Models.Tweet_attachments>("attachments", Attachments);
      writer.WriteStringValue("author_id", AuthorId);
      writer.WriteStringValue("community_id", CommunityId);
      writer.WriteCollectionOfObjectValues<global::XbyOpenApi.Core.Client.Models.ContextAnnotation>("context_annotations", ContextAnnotations);
      ...
      writer.WriteObjectValue<global::XbyOpenApi.Core.Client.Models.Tweet_edit_controls>("edit_controls", EditControls);
      writer.WriteCollectionOfPrimitiveValues<string>("edit_history_tweet_ids", EditHistoryTweetIds);
      writer.WriteObjectValue<global::XbyOpenApi.Core.Client.Models.FullTextEntities>("entities", Entities);
      writer.WriteObjectValue<global::XbyOpenApi.Core.Client.Models.Tweet_geo>("geo", Geo);
      ...
      writer.WriteCollectionOfObjectValues<global::XbyOpenApi.Core.Client.Models.Tweet_referenced_tweets>("referenced_tweets", ReferencedTweets);
      writer.WriteEnumValue<global::XbyOpenApi.Core.Client.Models.ReplySettingsWithVerifiedUsers>("reply_settings", ReplySettings);
      writer.WriteObjectValue<global::XbyOpenApi.Core.Client.Models.Tweet_scopes>("scopes", Scopes);
      writer.WriteStringValue("source", Source);
      writer.WriteCollectionOfObjectValues<global::XbyOpenApi.Core.Client.Models.UrlEntity>("suggested_source_links", SuggestedSourceLinks);
      writer.WriteObjectValue<global::XbyOpenApi.Core.Client.Models.Tweet_suggested_source_links_with_counts>("suggested_source_links_with_counts", SuggestedSourceLinksWithCounts);
      writer.WriteStringValue("text", Text);
      writer.WriteStringValue("username", Username);
      writer.WriteObjectValue<global::XbyOpenApi.Core.Client.Models.TweetWithheld>("withheld", Withheld);
