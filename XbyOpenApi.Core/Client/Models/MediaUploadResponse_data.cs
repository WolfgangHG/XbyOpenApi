...
#nullable restore
    ...
    /// <summary>
    /// Instantiates a new <see cref="global::XbyOpenApi.Core.Client.Models.MediaUploadResponse_data"/> and sets the default values.
    /// </summary>
    ...
    /// </summary>
    /// <returns>A <see cref="global::XbyOpenApi.Core.Client.Models.MediaUploadResponse_data"/></returns>
    /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
    public static global::XbyOpenApi.Core.Client.Models.MediaUploadResponse_data CreateFromDiscriminatorValue(IParseNode parseNode)
    {
      if (ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
      return new global::XbyOpenApi.Core.Client.Models.MediaUploadResponse_data();
    }
    /// <summary>
      ...
      return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "processing_info", n => { ProcessingInfo = n.GetObjectValue<global::XbyOpenApi.Core.Client.Models.ProcessingInfo>(global::XbyOpenApi.Core.Client.Models.ProcessingInfo.CreateFromDiscriminatorValue); } },
    ...
    public virtual void Serialize(ISerializationWriter writer)
    {
      ...
      writer.WriteObjectValue<global::XbyOpenApi.Core.Client.Models.ProcessingInfo>("processing_info", ProcessingInfo);
