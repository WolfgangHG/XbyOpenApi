...
#pragma warning disable CS1591
  public partial class Get2UsersIdTimelinesReverseChronologicalResponse_meta : IAdditionalDataHolder, IParsable
...
#nullable restore
    ...
    /// <summary>
    /// Instantiates a new <see cref="global::XbyOpenApi.Core.Client.Models.Get2UsersIdTimelinesReverseChronologicalResponse_meta"/> and sets the default values.
    /// </summary>
    public Get2UsersIdTimelinesReverseChronologicalResponse_meta()
    {
    ...
    /// </summary>
    /// <returns>A <see cref="global::XbyOpenApi.Core.Client.Models.Get2UsersIdTimelinesReverseChronologicalResponse_meta"/></returns>
    /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
    public static global::XbyOpenApi.Core.Client.Models.Get2UsersIdTimelinesReverseChronologicalResponse_meta CreateFromDiscriminatorValue(IParseNode parseNode)
    {
      if (ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
      return new global::XbyOpenApi.Core.Client.Models.Get2UsersIdTimelinesReverseChronologicalResponse_meta();
    }
    /// <summary>
