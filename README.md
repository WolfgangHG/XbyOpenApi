...
* [XbyOpenApi.Core](https://www.nuget.org/packages/XbyOpenApi.Core/) is the core REST client generated by Kiota (with one workaround for media upload), and nothing else.
It supports `netstandard2.0`.
* [XbyOpenApi.OAuth1](https://www.nuget.org/packages/XbyOpenApi.OAuth1/) contains some utility functions to perform OAuth1 authentication
independent of the UI framework. It supports `netstandard2.0`. More details below.
* [XbyOpenApi.OAuth1.WinForms](https://www.nuget.org/packages/XbyOpenApi.OAuth1.WinForms/) contains some a bit of WinForms GUI for fetching an OAuth1 access token.
It supports `net8.0-windows` and `net48`.
* [XbyOpenApi.OAuth2](https://www.nuget.org/packages/XbyOpenApi.OAuth2/) contains some utility functions to perform OAuth2 authentication
independent of the UI framework. It supports `netstandard2.0`. More details below.
* [XbyOpenApi.OAuth2.WinForms](https://www.nuget.org/packages/XbyOpenApi.OAuth2.WinForms/) contains some WinForms GUI for fetching an OAuth2 access token.
It supports `net8.0-windows` and `net48`.

# Using the X client
The core X client is found in package [XbyOpenApi.Core](https://www.nuget.org/packages/XbyOpenApi.Core/). But don't use this package directly,
...
Add a package reference to [XbyOpenApi.OAuth1.WinForms](https://www.nuget.org/packages/XbyOpenApi.OAuth1.WinForms/).
...
Add a package reference to [XbyOpenApi.OAuth2.WinForms](https://www.nuget.org/packages/XbyOpenApi.OAuth2.WinForms/).
...
Add a package reference to [XbyOpenApi.OAuth2](https://www.nuget.org/packages/XbyOpenApi.OAuth2/).
